...
static void layer_masked_mul_mat_vec_f_switch_fusion(
    ...
    if constexpr (ncols_dst == 1) {
        if (has_fusion) {
            layer_masked_mul_mat_vec_f<T, type_acc, ncols_dst, block_size, true><<<block_nums, block_dims, nbytes_shared, stream>>>
                (x, y, ids, fusion, dst, 
                layer_mask, layer_id,
                ncols, nrows, stride_row, stride_col_y, stride_col_dst,
                channel_ratio, stride_channel_x, stride_channel_y, stride_channel_dst,
                sample_ratio, stride_sample_x, stride_sample_y, stride_sample_dst);
            return;
       }
    ...
    layer_masked_mul_mat_vec_f<T, type_acc, ncols_dst, block_size><<<block_nums, block_dims, nbytes_shared, stream>>>
        (x, y, ids, fusion, dst, 
        layer_mask, layer_id,
        ncols, nrows, stride_row, stride_col_y, stride_col_dst,
        channel_ratio, stride_channel_x, stride_channel_y, stride_channel_dst,
...
void launch_layer_masked_mul_mat_vec_f_cuda(
    ...
    switch (block_size_best) {
        case   32: {
            ...
            //      channel_ratio_fd, stride_channel_x, stride_channel_y, stride_channel_dst,
            //      sample_ratio_fd, stride_sample_x, stride_sample_y, stride_sample_dst, block_dims, block_nums, nbytes_shared, stream);
            layer_masked_mul_mat_vec_f_switch_fusion<T, type_acc, ncols_dst, 32>
                (x, y, ids, fusion, dst, 
                 layer_mask, layer_id,
                 ncols/2, nchannels_y, stride_row, stride_col_y/2, stride_col_dst,
                 channel_ratio_fd, stride_channel_x, stride_channel_y, stride_channel_dst,
                 sample_ratio_fd, stride_sample_x, stride_sample_y, stride_sample_dst, block_dims, block_nums, nbytes_shared, stream);
        } break;
        case   64: {
            layer_masked_mul_mat_vec_f_switch_fusion<T, type_acc, ncols_dst, 64>
                (x, y, ids, fusion, dst, 
                 layer_mask, layer_id,
                 ncols/2, nchannels_y, stride_row, stride_col_y/2, stride_col_dst,
                 channel_ratio_fd, stride_channel_x, stride_channel_y, stride_channel_dst,
        ...
        case   96: {
            layer_masked_mul_mat_vec_f_switch_fusion<T, type_acc, ncols_dst, 96>
                (x, y, ids, fusion, dst, 
                 layer_mask, layer_id,
                 ncols/2, nchannels_y, stride_row, stride_col_y/2, stride_col_dst,
                 channel_ratio_fd, stride_channel_x, stride_channel_y, stride_channel_dst,
        ...
        case  128: {
            layer_masked_mul_mat_vec_f_switch_fusion<T, type_acc, ncols_dst, 128>
                (x, y, ids, fusion, dst, 
                 layer_mask, layer_id,
                 ncols/2, nchannels_y, stride_row, stride_col_y/2, stride_col_dst,
                 channel_ratio_fd, stride_channel_x, stride_channel_y, stride_channel_dst,
        ...
        case  160: {
            layer_masked_mul_mat_vec_f_switch_fusion<T, type_acc, ncols_dst, 160>
                (x, y, ids, fusion, dst, 
                 layer_mask, layer_id,
                 ncols/2, nchannels_y, stride_row, stride_col_y/2, stride_col_dst,
                 channel_ratio_fd, stride_channel_x, stride_channel_y, stride_channel_dst,
        ...
        case  192: {
            layer_masked_mul_mat_vec_f_switch_fusion<T, type_acc, ncols_dst, 192>
                (x, y, ids, fusion, dst, 
                 layer_mask, layer_id,
                 ncols/2, nchannels_y, stride_row, stride_col_y/2, stride_col_dst,
                 channel_ratio_fd, stride_channel_x, stride_channel_y, stride_channel_dst,
        ...
        case  224: {
            layer_masked_mul_mat_vec_f_switch_fusion<T, type_acc, ncols_dst, 224>
                (x, y, ids, fusion, dst, 
                 layer_mask, layer_id,
                 ncols/2, nchannels_y, stride_row, stride_col_y/2, stride_col_dst,
                 channel_ratio_fd, stride_channel_x, stride_channel_y, stride_channel_dst,
        ...
        case  256: {
            layer_masked_mul_mat_vec_f_switch_fusion<T, type_acc, ncols_dst, 256>
                (x, y, ids, fusion, dst, 
                 layer_mask, layer_id,
                 ncols/2, nchannels_y, stride_row, stride_col_y/2, stride_col_dst,
                 channel_ratio_fd, stride_channel_x, stride_channel_y, stride_channel_dst,
...
static void layer_masked_mul_mat_vec_f_cuda_switch_ncols_dst(
    ...
    switch (ncols_dst) {
        case 1:
            ...
            //      nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y,
            //      stride_channel_dst, nsamples_x, nsamples_dst, stride_sample_x, stride_sample_y, stride_sample_dst, stream);
            launch_layer_masked_mul_mat_vec_f_cuda<T, type_acc, 1>
                (x, y, ids, fusion, dst, 
                 layer_mask, layer_id,
                 ncols, nrows, stride_row, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y,
            ...
            break;
        case 2:
            launch_layer_masked_mul_mat_vec_f_cuda<T, type_acc, 2>
                (x, y, ids, fusion, dst, 
                 layer_mask, layer_id,
                 ncols, nrows, stride_row, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y,
            ...
            break;
        case 3:
            launch_layer_masked_mul_mat_vec_f_cuda<T, type_acc, 3>
                (x, y, ids, fusion, dst, 
                 layer_mask, layer_id,
                 ncols, nrows, stride_row, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y,
            ...
            break;
        case 4:
            launch_layer_masked_mul_mat_vec_f_cuda<T, type_acc, 4>
                (x, y, ids, fusion, dst, 
                 layer_mask, layer_id,
                 ncols, nrows, stride_row, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y,
            ...
            break;
        case 5:
            launch_layer_masked_mul_mat_vec_f_cuda<T, type_acc, 5>
                (x, y, ids, fusion, dst, 
                 layer_mask, layer_id,
                 ncols, nrows, stride_row, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y,
            ...
            break;
        case 6:
            launch_layer_masked_mul_mat_vec_f_cuda<T, type_acc, 6>
                (x, y, ids, fusion, dst, 
                 layer_mask, layer_id,
                 ncols, nrows, stride_row, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y,
            ...
            break;
        case 7:
            launch_layer_masked_mul_mat_vec_f_cuda<T, type_acc, 7>
                (x, y, ids, fusion, dst, 
                 layer_mask, layer_id,
                 ncols, nrows, stride_row, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y,
            ...
            break;
        case 8:
            launch_layer_masked_mul_mat_vec_f_cuda<T, type_acc, 8>
                (x, y, ids, fusion, dst, 
                 layer_mask, layer_id,
                 ncols, nrows, stride_row, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y,
...
static void layer_masked_mul_mat_vec_f_cuda(
    ...
    if constexpr(std::is_same_v<T, half>) {
        if (prec == GGML_PREC_DEFAULT) {
            layer_masked_mul_mat_vec_f_cuda_switch_ncols_dst<T, half>
                (x, y, ids, fusion, dst, 
                layer_mask, layer_id,
                ncols, nrows, ncols_dst, stride_row, stride_col_y, stride_col_dst,
                nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y,
                stride_channel_dst, nsamples_x, nsamples_dst, stride_sample_x, stride_sample_y, stride_sample_dst, stream);
            return;
        }
    ...
    //     nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y,
    //     stride_channel_dst, nsamples_x, nsamples_dst, stride_sample_x, stride_sample_y, stride_sample_dst, stream);
    layer_masked_mul_mat_vec_f_cuda_switch_ncols_dst<T, float>
        (x, y, ids, fusion, dst, 
        layer_mask, layer_id,
        ncols, nrows, ncols_dst, stride_row, stride_col_y, stride_col_dst,
        nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y,
...
void ggml_cuda_layer_masked_mul_mat_vec_f(ggml_backend_cuda_context & ctx, const ggml_tensor * src0, const ggml_tensor * src1, const ggml_tensor * ids, ggml_tensor * dst,
    const ggml_tensor * layer_mask, const int layer_id,
    const ggml_cuda_mm_fusion_args_host * fusion) {
    GGML_ASSERT(        src1->type == GGML_TYPE_F32);
    GGML_ASSERT(!ids ||  ids->type == GGML_TYPE_I32);
    GGML_ASSERT(         dst->type == GGML_TYPE_F32);
    ...
    switch (src0->type) {
        case GGML_TYPE_F32: {
            ...
            //     ne02, nchannels_y, nchannels_dst, s02, stride_channel_y, stride_channel_dst,
            //     ne03,              ne3,           s03, s13,              s3,                 prec, ctx.stream());
            layer_masked_mul_mat_vec_f_cuda(src0_d, src1_d, ids_d, fusion_local, dst_d, 
                layer_mask_d, layer_id,
                ne00, ne01, ncols_dst, s01, s11, s1,
                ne02, nchannels_y, nchannels_dst, s02, stride_channel_y, stride_channel_dst,
                ne03,              ne3,           s03, s13,              s3,                 prec, ctx.stream());
        } break;
        case GGML_TYPE_F16: {
